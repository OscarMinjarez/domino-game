...
public class Pruebas {
    public static void main(String[] args) {
        try {
            ...
            Player player1 = gameController.createPlayerOne("Oscar");
            Player player2 = gameController.createPlayerTwo("Aracely");
            Player player3 = gameController.createPlayerThree("Martin");
//            Player player4 = gameController.createPlayerFour("Hector");
