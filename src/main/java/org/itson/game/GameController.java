...
public class GameController {
    ...
    public Player createPlayerOne(String name) {
        return this.playerController.createPlayerOne(name);
    }
    public Player createPlayerTwo(String name) {
        return this.playerController.createPlayerTwo(name);
        
    }
    public Player createPlayerThree(String name) {
        return this.playerController.createPlayerThree(name);
    }
    public Player createPlayerFour(String name) {
        return this.playerController.createPlayerFour(name);
    }
